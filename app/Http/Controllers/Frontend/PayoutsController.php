...
class PayoutsController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.payouts.index', compact('payouts'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.payouts.create');
    }
    ...
    public function store(StorePayoutRequest $request)
    {
        ...
        return redirect()->route('frontend.payouts.index');
    }
    ...
    public function edit(Payout $payout)
    {
        ...
        return view('frontend.payouts.edit', compact('payout'));
    }
    ...
    public function show(Payout $payout)
    {
        ...
        return view('frontend.payouts.show', compact('payout'));
    }
